...
export const questionsData: Question[] = [
  ...
  {
    field: "socity",
    Question: "האם ראש ממשלה הנאשם בפלילים, שבתקופתו התרחש האסון הגדול ביותר לעם היהודי מאז השואה, ושבלשכתו קיים חשד לקשרים עם סוכן זר, יכול למנות ראש שב\"כ מבלי להימצא בניגוד עניינים חמור?",
    answers: answers,
  },
];
