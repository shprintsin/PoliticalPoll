...
export const questionsData: Question[] = [
  ...
  {
    field: "socity",
    Question: "האם ראש ממשלה המואשם בפלילים שבמשמרת שלו אירע האסון הגדול ביותר ליהודים בעד השואה שלשכתו חשודה במגע עם סוכן יכול למנות ראש  שב\"כ באופן שאין בו ניגוד עניינים?",
    answers: answers,
  },
];
